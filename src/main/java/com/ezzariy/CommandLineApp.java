...
public class CommandLineApp {
    private static final String WORKSPACE_PATH = "/mohammedamineezzariy/weather/data";
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (fileStatusListIterator.hasNext()) {
            ...
            // TODO: cli command hdfs dfs -ls /mohammedamineezzariy/weather/data
            extractFilePath(fileStatus.getPath(), fs)
                    .forEach(s -> System.out.println("FILE: " + s.getName() + " ===> PATH: " + s));

            // TODO: cli command hdfs fsck /mohammedamineezzariy/weather/data -files -blocks -locations
